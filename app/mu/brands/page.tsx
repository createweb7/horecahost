...
export const metadata: Metadata = {
  title: "Equipment Brands Available in Mauritius | HorecaHost",
  description:
    "Browse 60+ world-class hospitality and commercial kitchen equipment brands available for delivery to Mauritius. HorecaHost — your trusted supplier.",
  alternates: { canonical: `${SITE_ORIGIN}/mu/brands` },
  openGraph: {
    title: "Equipment Brands Available in Mauritius | HorecaHost",
    description: "60+ global brands — all available for delivery to Mauritius.",
    url: `${SITE_ORIGIN}/mu/brands`,
    siteName: "HorecaHost",
    type: "website",
    images: [{ url: `/api/og?title=Brands+for+Mauritius&description=60%2B+World-Class+Equipment+Brands`, width: 1200, height: 630 }],
  },
};

export default async function MauritiusBrandsPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Brands", item: `${SITE_ORIGIN}/mu/brands` },
    ],
  };
        ...
        <section className="relative bg-gray-900 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl xl:max-w-7xl px-6 sm:px-8 pt-6 pb-16">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-4 leading-tight">
              Equipment Brands Available in Mauritius
            </h1>
            <p className="text-gray-400 text-lg max-w-2xl">
              {brands.length}+ world-class hospitality and commercial kitchen equipment brands — all available for delivery to hotels, resorts, and restaurants across Mauritius.
            </p>
          </div>
        </section>
